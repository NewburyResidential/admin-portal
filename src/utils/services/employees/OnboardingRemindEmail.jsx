...
const LoginEmail = ({ employee }) => (
  <Html>
    <Head />
    <Preview>Onboarding Checklist</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={heading}>Onboarding Checklist</Heading>
        <Hr style={hr} />
        ...
        <Text style={paragraph}>
          {`${employee.fullName} has accepted thier offer letter and is ready to start their onboarding process. Please use the above link to view the checklist.`}
        </Text>
